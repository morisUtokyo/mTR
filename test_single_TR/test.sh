...
tmp=tmp
# error pattern
substitution_rate=5 #13
insertion_rate=3
deletion_rate=9 #5
# number of sequences
num_rand_seqs=1000 #100
# Length of random sequences before and after the tandem repeat
rand_seq_len=1000 #1000
...
for j in 10 30 50; do
# i unit length
#for i in 2 5 10; do
for i in 2 5 10 50 100 200; do
echo "------------------"
...
$mTR $tmp"/rand_seq.fasta" > $tmp"/rand_TRs.txt"
